-- Fix: version 013 was already applied remotely without this RPC (or with different content).
-- Idempotent: CREATE OR REPLACE + grants. Required for GET /admin/customers via Supabase RPC.
